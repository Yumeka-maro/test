    ...
    <div class="footer__inner inner">
      <div class="footer__header">
        ...
        <div class="footer__sns">
          <a href="https://www.facebook.com" class="footer__sns--facebook" target="_blank"><img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/FacebookLogo.png" alt="フェイスブック"></a>
          <a href="https://www.instagram.com" class="footer__sns--instagram" target="_blank"><img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/InstagramLogo.png" alt="インスタグラム"></a>
        </div>
      </div>
  ...
  <a href="index.html" class="back-to-top js-to-top"><img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/arrow.png" alt="矢印" class="arrow__img"></a>
  <?php wp_footer(); ?>
</body>

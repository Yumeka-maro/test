        ...
        <div class="swiper mv__swiper js-mv-swiper">
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <picture>
                <source srcset="<?php echo get_theme_file_uri(); ?>/assets/images/common/top-sp1.jpg" media="(max-width: 767px)">
                <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/top-pc1.jpg" alt="ターコイズブルーの海の中で茶色の亀が泳いでいる様子">
              </picture>
            </div>
            <div class="swiper-slide">
              <picture>
                <source srcset="<?php echo get_theme_file_uri(); ?>/assets/images/common/top-sp2.jpg" media="(max-width: 767px)">
                <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/top-pc2.jpg" alt="海の中で左側に亀、右側に人がダイビングしている様子">
              </picture>
            </div>
            <div class="swiper-slide">
              <picture>
                <source srcset="<?php echo get_theme_file_uri(); ?>/assets/images/common/top-sp3.jpg" media="(max-width: 767px)">
                <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/top-pc3.jpg" alt="晴れた空と海と白い船">
              </picture>
            </div>
            <div class="swiper-slide">
              <picture>
                <source srcset="<?php echo get_theme_file_uri(); ?>/assets/images/common/top-sp4.jpg" media="(max-width: 767px)">
              ...
              <div class="swiper-slide campaign-card">
                <div class="campaign-card__inner">
                  ...
                  <div class="campaign-card__body">
                      ...
                      <p class="campaign-card__title">ライセンス取得ライセンス取得ライセンス取得ライセンス取得</p>
        ...
        <div class="information__contents">
          ...
          <div class="information__text-wrapper">
            ...
            <div class="information__text">
              ...
              <div class="information__button"><a href="page-information.html" class="button">View more<span></span></a></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="price__inner inner">
        ...
        <div class="price__contents">
          <div class="price__img colorbox">
            <picture>
              <source srcset="<?php echo get_theme_file_uri(); ?>/assets/images/common/price.jpg" media="(max-width: 767px)">
